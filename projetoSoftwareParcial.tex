...
\include{extras/dadosProjetoSoftwareParcial}
...
% Capa
\include{pretextual/capaProjetoSoftwareParcial}
...
\include{capitulos/introducaoProjetoSoftwareParcial}

% PARTE - Define a divisão do documento em partes (Não é obrigatório)
\part{Preparação da pesquisa}
\include{capitulos/referenciasProjetoSoftwareParcial}
\include{capitulos/estadodaarteProjetoSoftwareParcial}
%\include{capitulos/ferramentasProjetoSoftwareParcial}
...
\bibliography{bibliografiaSoftwareParcial}
